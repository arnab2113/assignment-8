  ...
  return (
    <div className="max-w-4xl mx-auto p-4 space-y-12">
      <div className="space-y-2">
        <h1 className="text-4xl font-bold tracking-tight text-gray-900 dark:text-zinc-100">Input</h1>
      ...
      <section className="space-y-4 flex flex-col gap-10">
        <h2 className="text-2xl font-semibold text-gray-900 dark:text-zinc-100">Examples</h2>

        <div className="space-y-2">
          <h3 className="text-lg font-medium text-gray-900 dark:text-zinc-200">Normal</h3>

  ...
  return (
    <div className="max-w-4xl mx-auto p-6 space-y-12">
      <header className="space-y-2">
        <h1 className="text-4xl font-bold tracking-tight text-gray-900 dark:text-zinc-100">Carousel</h1>
      ...
      <section className="space-y-4">
        ...
        <ComponentDemo code={usageCode}>
          <div className="p-8 text-center bg-gray-100 dark:bg-zinc-800 rounded-lg w-full max-w-md">
            <p className="text-gray-500 dark:text-zinc-400 font-medium">Carousel Preview Coming Soon</p>
          </div>
        </ComponentDemo>
      </section>
